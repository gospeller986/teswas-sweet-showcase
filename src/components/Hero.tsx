...
<h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
  Master the Art of
  <span
    className="relative block font-bold text-transparent bg-clip-text 
               bg-[linear-gradient(120deg,white_0%,rgba(255,247,0,0.8)_80%,white_100%)] 
               bg-[length:200%_100%] animate-[shine_8s_linear_infinite]"
  >
    Baking <span className="text-transparent bg-clip-text 
               bg-[linear-gradient(120deg,white_0%,rgba(255,215,0,0.8))_80%,white_100%)] 
               bg-[length:200%_100%] animate-[shine_8s_linear_infinite]">
      Cakes
    </span>
  </span>
